...
data mixed;
    ...
    file 'mixed.dat';
    put date_time animal day silage dmi time tc rumenph PrumenphM
...
data xv_out;
    ...
    file 'xv_pred.dat';
    put replicate date_time animal day silage dmi rumenph PrumenphM
